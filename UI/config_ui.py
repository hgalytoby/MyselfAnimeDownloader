...
class Ui_Config(object):
    def setupUi(self, Config):
        ...
        self.save_pushButton.setGeometry(QtCore.QRect(20, 240, 51, 31))
        font = QtGui.QFont()
        ...
        self.cancel_pushButton.setGeometry(QtCore.QRect(590, 240, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.status_bar_checkBox.setEnabled(True)
        self.status_bar_checkBox.setGeometry(QtCore.QRect(20, 60, 551, 16))
        ...
        self.download_groupBox.setGeometry(QtCore.QRect(10, 150, 641, 81))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        Config.setTabOrder(self.note_pushButton, self.save_pushButton)
