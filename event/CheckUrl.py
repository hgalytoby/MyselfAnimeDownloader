...
def check_url(self):
    ...
    # 'https://myself-bbs.com/thread-45402-1-4.html'
    # if re.match(r'^https://myself-bbs.com/thread-[0-9]{5,5}-\d+-\d+.html$', url) or re.match(
    #         r'^http://myself-bbs.com/thread-[0-9]{5,5}-\d+-\d+.html$', url) or re.match(
    ...
    #     r'^https://www.myself-bbs.com/thread-[0-9]{5,5}-\d+-\d+.html$', url) or re.match(
    #     r'^http://www.myself-bbs.com/thread-[0-9]{5,5}-\d+-\d+.html$', url) or re.match(
